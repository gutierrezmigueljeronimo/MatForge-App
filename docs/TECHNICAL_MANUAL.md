...
- research background and training methodology, which are documented in the academic project files from [MatForge Research](https://github.com/gutierrezmigueljeronimo/MatForge-Research/tree/main).
